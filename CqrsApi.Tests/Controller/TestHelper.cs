...
namespace CqrsApi.Tests.Controller
{
    ...
    {
        public static Task<IList<MovieGetResponse>> MappedMovies(IList<Movie> collection, IMapperBase mapper)
        {
            return Task.FromResult(mapper.Map<IList<MovieGetResponse>>(collection));
        }
